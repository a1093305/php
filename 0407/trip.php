                ...
                <div><a name = 'itinerary'></a>
                    ...
                    <form action ='' method = 'post' enctype = 'multipart/form-data'><br>
                        <table style = 'left;background-color:#F0EDF7;' border = '1'>
                            <tr><td>
                                您的<b>姓名</b>（必填）：<input type = 'text' name = 'name' placeholder = '請輸入您的姓名' required><br>
                                您的<b>聯絡郵箱</b>（必填）：<input type = 'email' name = 'email' placeholder = '請輸入您的聯絡郵箱' required><br>
                                您的<b>聯絡電話</b>（必填）：<input type = 'tel' name = 'tel' pattern = '09[0-9]{8}' placeholder = '請輸入您的聯絡電話' required><br>
                                您的<b>性別</b>（必填）：
                                ...
                                您的<b>飲食偏好</b>：<br>
                                    <center>
                                        ...
                                        <input type = 'checkbox' id = 'change' value = 'all or not' onclick = 'allchange();'>全（不）選
                                        <input type = 'checkbox' value = 'reverse' onclick = 'reverse();'>反選<br>
                                    </center>
                                ...
                                <b>總人數</b>（必填）：<input type = 'number' name = 'number' value = '1' min = '1' required><br>
