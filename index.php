...
<body bgcolor='#D5E5DE'>
    ...
    <hr color = 'gray' width = 70%>
    <h3>位處國境之南的墾丁，不僅四季如春，又有著美麗的海岸，每年都能吸引不少遊客。<br><br>
    ...
    但墾丁的景點絕不只有美麗的大海。我們將帶您走訪：<br></h3>
    <h4>
    亞太水族中心、天明製藥觀光工廠、林後四林平地森林園區、<br>
    社頂自然公園、台電南部展示館、貓鼻頭風景區、龜山步道、<br>
    福安宮、六堆客家文化園區、梧棲觀光漁港、明玥園傳統文化歌廳<br></h4><h3>
    ...
    <div><a name = 'itinerary'></a>
        ...
        <a href ='https://www.pabp.gov.tw/CHT/cl0106.aspx' target = '_new'>
            <img width = '300' height = '200' src='https://www.pabp.gov.tw/Upload/IMAG0017.JPG'></a>
        <a href ='https://www.ktnp.gov.tw/News_Content2.aspx?n=5C28A0E32DF925F9&sms=C88B5251F308CE96&s=9C8B9499841F2B1D' target = '_new'>
            <img width = '300' height = '200' src='https://www.dbnsa.gov.tw/att/pic/b_11005779.jpg'></a>
        <a href ='https://thcdc.hakka.gov.tw/8268/' target = '_new'>
            <img width = '300' height = '200' src='https://thcdc.hakka.gov.tw/media/zu5d4doc/f1491999554841.jpg'></a>
        ...
        您需要填寫以下資料：
        <!--<form action ="end.php" method = "post"><br>-->
        <form>
        <table style = 'left;background-color:#F0EDF7;' border = '1'>
        <tr><td>您的<b>姓名</b>：<input type = 'text' name = 'name' placeholder = '請輸入您的姓名' required></td></tr>
        <tr><td>您的<b>聯絡郵箱</b>：<input type = 'email' name = 'email' placeholder = '請輸入您的聯絡郵箱' required></td></tr>
        <tr><td>您的<b>聯絡電話</b>：<input type = 'tel' name = 'tel' placeholder = '請輸入您的聯絡電話' required></td></tr>
        <tr><td>您的<b>性別</b>：<input type = 'radio' name = 'gender' value = 'male' required>男性　
                                <input type = 'radio' name = 'gender' value = 'female'>女性　
                                <input type = 'radio' name = 'gender' value = 'other'>其他</td></tr>
        <tr><td>您的<b>飲食偏好</b>：<br>
            ...
            <input type = 'checkbox' name = 'food' value = 'Starches' checked>澱粉類　</td></tr>
        <tr><td><b>T-shirt 尺寸（後附對照表）</b>：
            <select>
                <option>不需要</option>
                <option>S</option>
                <option>M</option>
        ...
        <tr><td><b>T-shirt 顏色</b>：<input type = 'color'></td></tr>
        <tr><td>您的<b>生日</b>（優惠確認用）：<input type = 'date'></td></tr>
        <tr><td><b>總人數</b>：<input type = 'number' min = '1' required></td></tr>
        <tr><td align = 'center'><br><input type = 'submit'></td></tr>
        </table>
        </form>
    </div><div> 
        <hr color = 'gray' width = 30%>
